...
--- PHP AND MYSQL ---
Reference: https://www.digitalocean.com/community/tutorials/how-to-install-lamp-stack-on-ubuntu#step-5-testing-php-processing-on-your-web-server
Notes: do not modify /etc/apache2/mods-enabled/dir.conf
Skip step 4, move this project's usrgrpsrv.conf file to /etc/apache2/sites-available/usrgrpsrv.conf instead. 
Run systemctl reload apache2, then systemctl restart apache2, then systemctl status apache2.
Visit http(s)://ip_addr/info.php to access php file
